...
public class StkLauncherActivityIV extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (service != null && service.StkQueryAvailable(PhoneConstants.SIM_ID_4) != StkAppService.STK_AVAIL_AVAILABLE)
        {
            int resId = 0;
            int simState = TelephonyManager.getDefault().getSimState(PhoneConstants.SIM_ID_4);
            
            CatLog.d("Stk-LAIV", "Not available simState:"+simState);
